...
def checkAuthenticationErrors():
    assert (contractAPI.get_ticker(contract_symbol='ETHUSDT')[0]['code'] == 1000), contractAPI.get_ticker(contract_symbol='ETHUSDT')[0]['message']
...
def get_last_price():
    ...
    return(contractAPI.get_ticker(contract_symbol='ETHUSDT')[0])
